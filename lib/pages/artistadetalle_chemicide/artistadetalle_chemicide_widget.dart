...
import 'artistadetalle_chemicide_model.dart';
export 'artistadetalle_chemicide_model.dart';

class ArtistadetalleChemicideWidget extends StatefulWidget {
  const ArtistadetalleChemicideWidget({super.key});

  static String routeName = 'artistadetalleChemicide';
  static String routePath = '/artistadetalleChemicide';

  @override
  State<ArtistadetalleChemicideWidget> createState() =>
      _ArtistadetalleChemicideWidgetState();
}

class _ArtistadetalleChemicideWidgetState
    extends State<ArtistadetalleChemicideWidget> {
  late ArtistadetalleChemicideModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ArtistadetalleChemicideModel());
